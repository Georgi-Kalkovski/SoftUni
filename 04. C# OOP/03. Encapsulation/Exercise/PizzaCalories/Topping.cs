namespace PizzaCalories
{
    ...
    class Topping
    {
        ...
        private string ToppingType
        {
            ...
            set
            {
                if (!allowedToppingTypes
                    .Any(tt => (string)tt
                    .GetType()
                    .GetProperty("ToppingType")
                    .GetValue(tt, null) == value
                    .ToLower()))
                {
        ...
        {
            var ttObject = allowedToppingTypes
                .First(tt => (string)tt
                .GetType()
                .GetProperty("ToppingType")
                .GetValue(tt, null) == this.ToppingType
                .ToLower());

            var ttModifier = (double)ttObject
                .GetType()
                .GetProperty("CaloriesModifier")
                .GetValue(ttObject, null);
