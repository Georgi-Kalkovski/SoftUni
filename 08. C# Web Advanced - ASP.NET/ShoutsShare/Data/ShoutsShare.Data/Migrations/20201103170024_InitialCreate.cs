    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentWorldUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimType = table.Column<string>(nullable: true),
                    ClaimValue = table.Column<string>(nullable: true),
                    ContentWorldUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserClaims", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_ContentWorldUser_ContentWorldUserId",
                        column: x => x.ContentWorldUserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_ContentWorldUser_ContentWorldUserId",
                        column: x => x.ContentWorldUserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_ContentWorldUser_ContentWorldUserId",
                        column: x => x.ContentWorldUserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_ContentWorldUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YoutubeLink = table.Column<string>(maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NewsComments_ContentWorldUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoutsRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoutsRatings_ContentWorldUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShoutsRatings_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VideoComments_ContentWorldUser_UserId",
                        column: x => x.UserId,
                        principalTable: "ContentWorldUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoCountries", x => new { x.VideoId, x.CountryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoCreators", x => new { x.VideoId, x.CreatorId });
                    table.ForeignKey(
                        name: "FK_VideoCreators_Creators_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Creators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VideoCreators_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoReviews", x => new { x.VideoId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_VideoReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserClaims_ContentWorldUserId",
                table: "AspNetUserClaims",
                column: "ContentWorldUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserLogins_ContentWorldUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_ContentWorldUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentWorldUser_IsDeleted",
                table: "ContentWorldUser",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoutsRatings_IsDeleted",
                table: "ShoutsRatings",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ShoutsRatings_UserId",
                table: "ShoutsRatings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoutsRatings_VideoId",
                table: "ShoutsRatings",
                column: "VideoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoCountries_CountryId",
                table: "VideoCountries",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoCountries_IsDeleted",
                table: "VideoCountries",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_VideoCreators_CreatorId",
                table: "VideoCreators",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoCreators_IsDeleted",
                table: "VideoCreators",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoGenres_IsDeleted",
                table: "VideoGenres",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_VideoReviews_IsDeleted",
                table: "VideoReviews",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_VideoReviews_ReviewId",
                table: "VideoReviews",
                column: "ReviewId");
